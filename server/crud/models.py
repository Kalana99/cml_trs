...
class Event(models.Model):
    ...
    trans_id = models.UUIDField(default=uuid.uuid4, editable=False)  # UUID to store the transaction ID
    ...
    client_id = models.CharField(default=uuid.uuid4)  # Client ID reference
